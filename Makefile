...
# Makefile for re-worker-httprequest
#
...
RPMSPEC := $(RPMSPECDIR)/re-worker-httprequest.spec
...
srpm: rpmcommon
	...
	@find rpm-build -maxdepth 2 -name 're-worker-httprequest*src.rpm' | awk '{print "    " $$1}'
	@echo "#############################################"
...
rpm: rpmcommon
	...
	@find rpm-build -maxdepth 2 -name 're-worker-httprequest*.rpm' | awk '{print "    " $$1}'
	@echo "#############################################"
